...
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-DEFAULT.001.cam.h0.PRECT.203501-206912.nc'];
AOD = ncread([vol nam],var);
T_MA2{1,1}=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-DEFAULT.002.cam.h0.PRECT.203501-206912.nc'];
AOD = ncread([vol nam],var);
T_MA2{1,2}=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-DEFAULT.003.cam.h0.PRECT.203501-206912.nc'];
AOD = ncread([vol nam],var);
...
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-LOWER-0.5.001.cam.h0.PRECT.203501-206912.nc'];
AOD = ncread([vol nam],var);
T_MA2{2,1}=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-LOWER-0.5.002.cam.h0.PRECT.203501-206912.nc'];
AOD = ncread([vol nam],var);
T_MA2{2,2}=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-LOWER-0.5.003.cam.h0.PRECT.203501-206912.nc'];
AOD = ncread([vol nam],var);
T_MA2{2,3}=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3));


nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-LOWER-1.0.001.cam.h0.PRECT.203501-206912.nc'];
AOD = ncread([vol nam],var);
T_MA2{3,1}=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-LOWER-1.0.002.cam.h0.PRECT.203501-207012.nc'];
AOD = ncread([vol nam],var);
T_MA2{3,2}=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-GAUSS-LOWER-1.0.003.cam.h0.PRECT.203501-207012.nc'];
AOD = ncread([vol nam],var);
...
nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.001.cam.h0.PRECC.198601-201412.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.001.cam.h0.PRECL.198601-201412.nc'];
AOD2 = ncread([vol nam],var2);
T_1=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.001.cam.h0.PRECC.201501-206412.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.001.cam.h0.PRECL.201501-206412.nc'];
AOD2 = ncread([vol nam],var2);
T_2=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.001.cam.h0.PRECC.206501-209912.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.001.cam.h0.PRECL.206501-209912.nc'];
AOD2 = ncread([vol nam],var2);
T_3=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

T_base{1} = cat(3,T_1,T_2,T_3);

nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECC.195001-199912.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECL.195001-199912.nc'];
AOD2 = ncread([vol nam],var2);
T_1=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECC.200001-201412.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECL.200001-201412.nc'];
AOD2 = ncread([vol nam],var2);
T_2=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECC.201501-206412.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECL.201501-206412.nc'];
AOD2 = ncread([vol nam],var2);
T_3=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECC.206501-209812.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.002.cam.h0.PRECL.206501-209812.nc'];
AOD2 = ncread([vol nam],var2);
T_4=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

T_base{2} = cat(3,T_1,T_2,T_3,T_4);

nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECC.195001-199912.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECL.195001-199912.nc'];
AOD2 = ncread([vol nam],var2);
T_1=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECC.200001-201412.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWmaHIST.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECL.200001-201412.nc'];
AOD2 = ncread([vol nam],var2);
T_2=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECC.201501-201912.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECL.201501-201912.nc'];
AOD2 = ncread([vol nam],var2);
T_3=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECC.202001-206912.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECL.202001-206912.nc'];
AOD2 = ncread([vol nam],var2);
T_4=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECC.207001-209912.nc'];
AOD = ncread([vol nam],var);
nam = ['b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.003.cam.h0.PRECL.207001-209912.nc'];
AOD2 = ncread([vol nam],var2);
T_5=squeeze(mean(reshape(AOD,288,192,12,size(AOD,3)/12),3))+squeeze(mean(reshape(AOD2,288,192,12,size(AOD2,3)/12),3));

T_base{3} = cat(3,T_1,T_2,T_3,T_4,T_5);


save('p_maps_gauss.mat','T_MA2','T_base','lat','lon')
end
...
%%
T_MA{1} = (T_MA2{1,1}+T_MA2{1,2}+T_MA2{1,3})/3 * tfact;
T_MA{2} = (T_MA2{2,1}+T_MA2{2,2}+T_MA2{2,3})/3 * tfact;
T_MA{3} = (T_MA2{3,1}+T_MA2{3,2}(:,:,1:35)+T_MA2{3,3}(:,:,1:35))/3 * tfact;
T_BA = (T_base{1}(:,:,1:113) + T_base{2}(:,:,36:148) + T_base{3}(:,:,36:148))/3 * tfact;
...
ylabel(hl, '\Delta P (mm/day)')
end
mlabel off; plabel off; gridm off
end

set(gcf,'renderer','painters')
print(gcf,'-depsc2',['psurf_maps.eps'])
...
% load coastlines
% geoshow(coastlat,coastlon,'Color','k')
% scatterm(lat_Tgr{2},lon_Tgr{2},.4,'k','filled')
% caxis([mmin mmax])
% set(gca,'Linewidth',2)
% title({nm_ssp{1};['- ' nm_ssp{2}]},'FontSize',14)
% 
% hc1{2}=subplot(2,3,4);
% 
% lon2 = lon;
...
% load coastlines
% geoshow(coastlat,coastlon,'Color','k')
% scatterm(lat_Tg{2},lon_Tg{2},.4,'k','filled')
% caxis([mmin mmax])
% set(gca,'Linewidth',2)
% title({nm_sai{1};['- ' nm_ssp{2}]},'FontSize',14)
% hc1{2}.Position(2)=hc1{2}.Position(2)+.04*5;
% hc1{2}.Position(1)=hc1{2}.Position(1)+.04;
% 
% hc1{3}=subplot(2,3,5);
% 
% lon2 = lon;
...
% load coastlines
% geoshow(coastlat,coastlon,'Color','k')
% scatterm(lat_Tg1{3},lon_Tg1{3},.4,'k','filled')
% caxis([mmin mmax])
% set(gca,'Linewidth',2)
% title({nm_sai{2};['- ' nm_ssp{3}]},'FontSize',14)
% hc1{3}.Position(2)=hc1{2}.Position(2);
% hl = colorbar('FontSize',16,'YTick',(v2),'Linewidth',2,'Location','southoutside');
% hl.Position(1) = hl.Position(1)-.06;
% hl.Position(2) = hl.Position(2)-.06;
% hl.Position(3) = hl.Position(3)*1.5;
% hl.Position(4) = hl.Position(4)*1.1;
% ylabel(hl, '\Delta P (mm/day)')
% 
% hc1{4}=subplot(2,3,6);
% 
...
% load coastlines
% geoshow(coastlat,coastlon,'Color','k')
% scatterm(lat_Tg2{4},lon_Tg2{4},.4,'k','filled')
% caxis([mmin mmax])
% set(gca,'Linewidth',2)
% title({nm_sai{3};['- ' nm_ssp{4}]},'FontSize',14)
% hc1{4}.Position(2)=hc1{2}.Position(2);
% hc1{4}.Position(1)=hc1{4}.Position(1)-.04;
% 
% set(gcf,'renderer','painters')
% print(gcf,'-depsc2',['psurf_maps_only4.eps'])